import {WOODS_SPAWNS,WOODS_TREES,isWoodsMonster,woodsMonsterHealth} from './woods.ts';
...
export const WORLD={width:3800,height:1700,spawn:{x:1150,y:880}};
...
export function blocked(x:number,y:number){return x<WORLD_LIMITS.left||y<WORLD_LIMITS.top||x>WORLD_LIMITS.right||y>WORLD_LIMITS.bottom||WOODS_TREES.some(t=>Math.hypot(x-t.x,y-t.y)<22)||BUILDINGS.some(b=>x>b.x-12&&x<b.x+b.w+12&&y>b.y+b.h-65&&y<b.y+b.h+8)}
...
NPCS.push({id:'ranger',name:'Moss · Forest Ranger',x:2470,y:760,sx:195,sy:222,sw:89,sh:105,text:'The Ironroot Guardian has awakened. Help me reclaim the forest. [E] Accept or turn in Roots of Rust.'});
